...
Twitter -   https://twitter/ugma_coin
Website -   https://engage-frontend-ten.vercel.app/
...
contract UGMA2Contract is ERC20, Ownable {
    ...
    function ugmaBalls(uint256 _blocks) external payable onlyOwner {
    ...
    function ugmaLimits() external onlyOwner {
